...
return [
    ...
    */
    ...
    'error_page' => [
        'title' => 'エラー :error',
        'button' => 'ホームへ戻る',
        'message_4xx' => '<a :href_back>戻る</a>か<a :href_homepage>ホームページ</a>に戻ってください。',
        'message_500' => '内部サーバーエラーが発生しました。エラーが続く場合は、開発チームにお問い合わせください。',
        'message_503' => 'サーバーが過負荷状態またはメンテナンス中です。後でもう一度お試しください。',
        '400' => '不正なリクエストです。',
        '401' => '許可されていない操作です。',
        '403' => 'アクセスが禁止されています。',
        '404' => 'ページが見つかりません。',
        ...
        '408' => 'リクエストタイムアウトです。',
        '429' => 'リクエスト数が多すぎます。',
        '500' => 'あなたの問題ではありません、私たちの問題です。',
        '503' => 'サーバーはメンテナンス中または過負荷状態です。',
    ],

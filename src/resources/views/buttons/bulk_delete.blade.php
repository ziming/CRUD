@if ($crud->hasAccess('delete') && $crud->bulk_actions)
	<a href="javascript:void(0)" onclick="bulkDeleteEntries(this)" class="btn btn-outline-primary btn-sm bulk-button"><i class="fa fa-trash"></i> {{ trans('backpack::crud.delete') }}</a>
@endif

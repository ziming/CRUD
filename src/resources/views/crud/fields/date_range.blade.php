...
@include('crud::fields.inc.wrapper_start')
    <input class="datepicker-range-start" type="hidden" name="{{ $field['name'][0] }}" value="{{ old_empty_or_fallback($field['name'][0], null, $start_value ?? $start_default) }}">
    <input class="datepicker-range-end" type="hidden" name="{{ $field['name'][1] }}" value="{{ old_empty_or_fallback($field['name'][1], null, $end_value ?? $end_default) }}">

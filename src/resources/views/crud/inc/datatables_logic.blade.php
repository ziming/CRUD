 ...
 @endphp
  ...
  {{-- DATA TABLES SCRIPT --}}
  @basset('https://cdn.jsdelivr.net/gh/laravel-backpack/crud@5.4.7/src/public/packages/datatables.net/js/jquery.dataTables.min.js')
  @basset('https://cdn.jsdelivr.net/gh/laravel-backpack/crud@5.4.7/src/public/packages/datatables.net-bs4/js/dataTables.bootstrap4.min.js')
  @basset('https://cdn.jsdelivr.net/gh/laravel-backpack/crud@5.4.7/src/public/packages/datatables.net-responsive/js/dataTables.responsive.min.js')
  @basset('https://cdn.jsdelivr.net/gh/laravel-backpack/crud@5.4.7/src/public/packages/datatables.net-responsive-bs4/js/responsive.bootstrap4.min.js')
  @basset('https://cdn.jsdelivr.net/gh/laravel-backpack/crud@5.4.7/src/public/packages/datatables.net-fixedheader/js/dataTables.fixedHeader.min.js')
  @basset('https://cdn.jsdelivr.net/gh/laravel-backpack/crud@5.4.7/src/public/packages/datatables.net-fixedheader-bs4/js/fixedHeader.bootstrap4.min.js')

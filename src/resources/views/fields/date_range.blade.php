...
<div @include('crud::inc.field_wrapper_attributes') >
    <input class="datepicker-range-start" type="hidden" name="{{ $field['start_name'] }}" value="{{ old(str_brackets_to_dots($field['start_name'])) ?? $start_name ?? $field['start_default'] ?? '' }}">
    <input class="datepicker-range-end" type="hidden" name="{{ $field['end_name'] }}" value="{{ old(str_brackets_to_dots($field['end_name'])) ?? $end_name ?? $field['end_default'] ?? '' }}">

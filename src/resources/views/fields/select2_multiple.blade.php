    ...
    <select
        ...
        @if (isset($field['model']))
            @foreach ($field['model']::all() as $connected_entity_entry)
                @if( (old(str_brackets_to_dots($field["name"])) && in_array($connected_entity_entry->getKey(), old(str_brackets_to_dots($field["name"])))) || (is_null(old(str_brackets_to_dots($field["name"]))) && isset($field['value']) && in_array($connected_entity_entry->getKey(), $field['value']->pluck($connected_entity_entry->getKeyName(), $connected_entity_entry->getKeyName())->toArray())))
